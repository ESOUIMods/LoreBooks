...
SafeAddString(LBOOKS_QUEST_BOOK, "クエストで入手可能な本", 1)
SafeAddString(LBOOKS_MAYBE_NOT_HERE, "[本は多分ここにない]", 1)
...
--appearance
SafeAddString(LBOOKS_PIN_TEXTURE, "マップピンのアイコンの選択", 1)
SafeAddString(LBOOKS_PIN_TEXTURE_EIDETIC, "マップピンのアイコンの選択 (<<1>>)", 1)
SafeAddString(LBOOKS_PIN_TEXTURE_DESC, "マップピンのアイコンを選択します。", 1)
...
SafeAddString(LBOOKS_PIN_SIZE, "ピンのサイズ", 1)
SafeAddString(LBOOKS_PIN_SIZE_DESC, "マップピンのサイズを設定します。", 1)
SafeAddString(LBOOKS_PIN_LAYER, "ピンのレイヤー", 1)
SafeAddString(LBOOKS_PIN_LAYER_DESC, "マップピンのレイヤーを設定します。", 1)
...
--compass
SafeAddString(LBOOKS_COMPASS_UNKNOWN, "伝説の書物をコンパスに表示", 1)
SafeAddString(LBOOKS_COMPASS_UNKNOWN_DESC, "未発見の伝説の書物をコンパスに表示するかどうか。", 1)
SafeAddString(LBOOKS_COMPASS_DIST, "マップピンの距離", 1)
SafeAddString(LBOOKS_COMPASS_DIST_DESC, "コンパスに表示するピンの最大距離です。", 1)

--filters
SafeAddString(LBOOKS_UNKNOWN, "未発見の伝説の書物の表示", 1)
SafeAddString(LBOOKS_UNKNOWN_DESC, "未発見の伝説の書物のアイコンをマップに表示するかどうか。", 1)
SafeAddString(LBOOKS_COLLECTED, "収集済みの伝説の書物の表示", 1)
SafeAddString(LBOOKS_COLLECTED_DESC, "収集済みの伝説の書物のアイコンをマップに表示するかどうか。", 1)

SafeAddString(LBOOKS_SHARE_DATA, "発見をLoreBooksの作者に共有", 1)
SafeAddString(LBOOKS_SHARE_DATA_DESC, "有効にするとあなたの発見をゲーム内のメールを使ってLoreBooksの作者に自動的に共有します。\nこのオプションはEUユーザーにのみ有効ですが、収集されたデータはNAユーザーにも共有されます。\nメール送信時にわずかなスキルのラグが発生することがあるので注意してください。メールは本を30冊読むたびに裏で送信されます。", 1)

SafeAddString(LBOOKS_EIDETIC, "未発見の直観記憶を表示", 1)
SafeAddString(LBOOKS_EIDETIC_DESC, "未発見の直観記憶の巻物をマップに表示するかどうか。この巻物は魔術師ギルド進行に関連しない伝承関連のもので、タムリエルの情報を提供するだけです。", 1)
...
--research
SafeAddString(LBOOKS_RANDOM_POSITION, "[本棚]", 1)
...
SafeAddString(LBOOKS_RS_FEW_BOOKS_MISSING, "シャリドールの蔵書がいくつか欠落しています…", 1)
SafeAddString(LBOOKS_RS_MDONE_BOOKS_MISSING, "魔術師ギルドのスキルラインが完成しました！ でもいくつかの本が欠落しています", 1)
SafeAddString(LBOOKS_RS_GOT_ALL_BOOKS, "シャリドールの蔵書をすべて収集しました。おめでとう！", 1)

SafeAddString(LBOOKS_RE_FEW_BOOKS_MISSING, "直観記憶の本がいくつか欠落しています…", 1)
SafeAddString(LBOOKS_RE_THREESHOLD_ERROR, "直観記憶のレポートを受け取るにはまだ本を集める必要があります…", 1)
